...
public class TestSponsorRestServiceWithJerseyTestFramework extends JerseyTest{
...
//    }
    ...
    public void testSmth(){
    	Response response = target("RESTwithPersistence/sponsors/2").request().get(Response.class);
